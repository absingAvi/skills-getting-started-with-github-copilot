...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for intermediate to advanced players",
    ...
    "Music Ensemble": {
        "description": "Perform in an ensemble with various instruments and vocal parts",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "emily@mergington.edu", "noah@mergington.edu"]
    },
    "Debate Club": {
